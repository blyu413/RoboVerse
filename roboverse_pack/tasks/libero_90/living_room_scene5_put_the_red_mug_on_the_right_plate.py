"""Configuration for the Libero living room scene5 put the red mug on the right plate task."""
...
class LiberoLivingRoomScene5PutTheRedMugOnTheRightPlateTask(Libero90BaseTask):
    """Configuration for the Libero living room scene5 put the red mug on the right plate task.
    ...
    Goal: red_coffee_mug is on plate_2.
    """
    ...
    task_desc = "Put the red mug on the right plate (living_room_scene5)"

    workspace_name = ("living_room_table",)
    workspace_offset = ((0.0, 0, 0),)
    workspace_size = ((1.0, 1.2, 0.1),)

    traj_filepath = "roboverse_data/trajs/libero90/libero_90_living_room_scene5_put_the_red_mug_on_the_right_plate_traj_v2.pkl"

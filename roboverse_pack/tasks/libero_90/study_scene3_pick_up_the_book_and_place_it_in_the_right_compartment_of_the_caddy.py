"""Configuration for the Libero study scene3 pick up the book and place it in the right compartment of the caddy task."""
...
class LiberoStudyScene3PickUpTheBookAndPlaceInTheRightCompartmentOfTheCaddyTask(Libero90BaseTask):
    """Configuration for the Libero study scene3 pick up the book and place it in the right compartment of the caddy task.
    ...
    task_desc = "Pick up the black_book and place it in the right compartment of the desk_caddy (study_scene3)"

    workspace_name = ("study_table",)
    workspace_offset = ((0, 0, 0),)
    workspace_size = ((1.0, 1.2, 0.1),)

    traj_filepath = "roboverse_data/trajs/libero90/libero_90_study_scene3_pick_up_the_book_and_place_it_in_the_right_compartment_of_the_caddy_traj_v2.pkl"

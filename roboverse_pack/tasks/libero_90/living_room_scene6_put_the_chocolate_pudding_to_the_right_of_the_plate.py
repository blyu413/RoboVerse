"""Configuration for the Libero living room scene6 put the chocolate pudding to the right of the plate task."""
...
@register_task(
    "libero_90.living_room_scene6_put_the_chocolate_pudding_to_the_right_of_the_plate",
    "living_room_scene6_put_the_chocolate_pudding_to_the_right_of_the_plate",
)
class LiberoLivingRoomScene6PutTheChocolatePuddingToTheRightOfPlateTask(Libero90BaseTask):
    """Task: Put the chocolate_pudding to the right of the plate in living_room_scene6.
    ...
    Goal: Place chocolate_pudding to the right of the plate.
    """
    ...
    task_desc = "Put the chocolate_pudding to the right of the plate (living_room_scene6)"

    workspace_name = ("living_room_table",)
    workspace_offset = ((0.0, 0, 0.42),)
    workspace_size = ((1.0, 1.2, 0.1),)

    traj_filepath = "roboverse_data/trajs/libero90/libero_90_living_room_scene6_put_the_chocolate_pudding_to_the_right_of_the_plate_traj_v2.pkl"

    def _terminated(self, states: TensorState) -> torch.Tensor:
        """Task success: chocolate_pudding is to the right of the plate (x > plate.x + threshold)."""
        ...
        y_in_range = (y_diff > -0.2) & (y_diff < 0)

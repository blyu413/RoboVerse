"""Configuration for the Libero study scene1 pick up the yellow and white mug and place it to the right of the caddy task."""
...
class LiberoStudyScene1PickUpTheYellowAndWhiteMugAndPlaceRightOfCaddyTask(Libero90BaseTask):
    """Configuration for the Libero study scene1 pick up the yellow and white mug and place it in the right compartment of the caddy task.
    ...
    task_desc = "Pick up the white_yellow_mug and place it to the right of the desk_caddy (study_scene1)"

    workspace_name = ("study_table",)
    workspace_offset = ((0, 0, 0),)
    workspace_size = ((1.0, 1.2, 0.1),)

    traj_filepath = "roboverse_data/trajs/libero90/libero_90_study_scene1_pick_up_the_yellow_and_white_mug_and_place_it_to_the_right_of_the_caddy_traj_v2.pkl"

    def _terminated(self, states: TensorState) -> torch.Tensor:
        """Task success checker: white_yellow_mug is to the right of desk_caddy (x > caddy.x + threshold, y/z close)."""
        mug_pos = states.objects["white_yellow_mug"].root_state[:, :3]

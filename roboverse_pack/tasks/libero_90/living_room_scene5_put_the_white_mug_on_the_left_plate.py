"""Configuration for the Libero living room scene5 put the white mug on the left plate task."""
...
@register_task(
    "libero_90.living_room_scene5_put_the_white_mug_on_the_left_plate",
    "living_room_scene5_put_the_white_mug_on_the_left_plate",
)
class LiberoLivingRoomScene5PutTheWhiteMugOnTheLeftPlateTask(Libero90BaseTask):
    """Configuration for the Libero living room scene5 put the white mug on the left plate task.
    ...
    task_desc = "Put the white mug on the left plate (living_room_scene5)"

    workspace_name = ("living_room_table",)
    workspace_offset = ((0.0, 0, 0),)
    workspace_size = ((1.0, 1.2, 0.1),)

    traj_filepath = "roboverse_data/trajs/libero90/libero_90_living_room_scene5_put_the_white_mug_on_the_left_plate_traj_v2.pkl"
